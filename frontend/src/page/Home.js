  ...
  return (
    <div className='p-2 md:p-4'>
      ...
      my-5">
        ...
        onClick={onClick}
        >
          <div className="text-3xl p-5  rounded-full cursor-pointer  text-white">
            <img
              src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_category/w_56,dpr_1,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/luminosity/1707485360039-fd903d.jpeg"
              className=""
            />
          </div>
          <p className="text-center font-medium my-1 capitalize">Men salon</p>
        </div> */}
